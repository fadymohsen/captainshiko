              ...
              <section className="relative">
                <FadeUp>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative aspect-[9/16] max-w-[400px] mx-auto lg:mx-0 rounded-[2.5rem] overflow-hidden bg-surface-light border-4 border-white/5 shadow-2xl overflow-hidden">
                      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-background/20 to-background/80 flex flex-col items-center justify-center p-10 text-center">
                        ...
                        <p className="text-xs text-muted leading-relaxed">
                          Your custom reel transformation story or plan explainer will play here.
                        </p>
                      </div>
                        ...
                        >
                          ...
                          <div className="group relative">
                            <div className="p-8 rounded-3xl bg-background/40 border border-white/5 flex flex-col items-center lg:items-start group-hover:border-accent/20 transition-all">
                              ...
                              <div className="flex items-baseline gap-2">
                                <span className="text-5xl font-black group-hover:text-foreground transition-colors">{currentPricing.monthly}</span>
                          ...
                          <div className="group relative">
                            ...
                            <div className="p-8 rounded-3xl bg-accent/[0.03] border border-accent/20 flex flex-col items-center lg:items-start group-hover:bg-accent/5 transition-all">
                              ...
                              <div className="flex items-baseline gap-2">
                                <span className="text-5xl font-black text-accent-light">{currentPricing.quarterly}</span>
                                <span className="text-xl font-bold text-muted">{currentPricing.currency}</span>
                              </div>
                              {currentPricing.note && (
                                <div className="mt-4 text-[10px] font-black text-accent-light flex items-center gap-2 bg-accent/10 px-3 py-1 rounded-lg">
