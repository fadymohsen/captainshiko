...
export default function PlansPage() {
  ...
  // The slugs are: elite-transformation, self-starter, elite-coaching, fuel-and-focus, power-and-performance
  const planSlugs = [
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <main className="flex-grow pt-32 pb-20 relative">
        {/* Background glow effects to match design system */}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {plans.map((plan, i) => (
              <StaggerItem key={plan.slug} className="w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.4rem)] max-w-sm lg:max-w-none">
