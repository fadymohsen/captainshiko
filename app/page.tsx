          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="aspect-[3/4] rounded-xl overflow-hidden relative">
              ...
              <div className="absolute inset-0 flex items-end p-4">
                <span className="text-xs text-white/80 font-semibold">Strength Training</span>
              </div>
            </div>
            <div className="aspect-[3/4] rounded-xl overflow-hidden relative mt-8">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-background/70 to-transparent" />
              <div className="absolute inset-0 flex items-end p-4">
                <span className="text-xs text-white/80 font-semibold">Conditioning</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              {
                title: "Workout",
                desc: "Custom training programs tailored to your fitness level and goals.",
                img: "https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?w=500&h=667&fit=crop",
              },
              {
                title: "Nutrition",
                desc: "Macro-based meal plans designed to fuel performance and recovery.",
                img: "https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=500&h=667&fit=crop",
              },
              {
                title: "Coaching",
                desc: "1-on-1 online coaching with weekly check-ins and accountability.",
                img: "https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=500&h=667&fit=crop",
              },
              {
                title: "Lifestyle",
                desc: "Holistic guidance on sleep, stress management, and habits.",
                img: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=500&h=667&fit=crop",
              },
            ].map((item) => (
              <div
                key={item.title}
            ...
            {[
              {
                ...
                img: "https://images.unsplash.com/photo-1567013127542-490d757e51fc?w=500&h=667&fit=crop&crop=faces",
              },
              {
                name: "Strength Coach",
                role: "Resistance Training Specialist",
                img: "https://images.unsplash.com/photo-1597347316205-36f6c451902a?w=500&h=667&fit=crop&crop=faces",
              },
              {
                name: "Nutrition Coach",
                role: "Diet & Supplementation",
                img: "https://images.unsplash.com/photo-1518611012118-696072aa579a?w=500&h=667&fit=crop&crop=faces",
              },
            ].map((coach) => (
              <div key={coach.name} className="group">
                <div className="aspect-[3/4] rounded-xl overflow-hidden relative mb-4">
                  <Image
                    src={coach.img}
                    alt={coach.name}
                    fill
