    ...
    <div className="min-h-screen bg-background flex">
      ...
      <aside className="w-64 border-r border-white/5 bg-background/50 backdrop-blur-xl flex flex-col p-6 hidden md:flex">
        ...
        <nav className="flex flex-col gap-2 flex-grow">
          ...
          <a href="/admin/dashboard/sessions" className="py-3 px-4 rounded-xl text-muted text-sm font-bold tracking-wider hover:bg-white/5 hover:text-foreground transition-colors">Sessions</a>
