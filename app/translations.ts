...
export const translations = {
  en: {
    ...
    checkout: {
      ...
      instapayTitle: "Upload Payment Receipt",
      instapayNote: "Please complete your payment on InstaPay, then upload a screenshot of your receipt below.",
      uploadReceipt: "Upload Receipt Screenshot",
      submitReceipt: "Submit Receipt",
      receiptUploaded: "Receipt Uploaded!",
      receiptUploadedNote: "Thank you! We've received your receipt and will verify your payment shortly. Check your email for confirmation.",
  ...
  ar: {
    ...
    checkout: {
      ...
      instapayTitle: "ارفع إيصال الدفع",
      instapayNote: "من فضلك أتمم الدفع على إنستاباي، وبعدين ارفع صورة الإيصال هنا.",
      uploadReceipt: "ارفع صورة الإيصال",
      submitReceipt: "إرسال الإيصال",
      receiptUploaded: "تم رفع الإيصال!",
      receiptUploadedNote: "شكراً! استلمنا الإيصال وهنراجع الدفع في أقرب وقت. هتوصلك رسالة تأكيد على الإيميل.",
