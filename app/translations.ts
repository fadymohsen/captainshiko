...
export const translations = {
  en: {
    ...
    checkout: {
      ...
      paidButton: "Send the Receipt",
      instapayTitle: "InstaPay Payment",
      instapayNote: "You are about to be redirected to InstaPay to complete your payment.",
      instapayInstructions: "1. Click 'Go to InstaPay' below.\n2. Complete the transfer.\n3. Send a screenshot of the receipt to our WhatsApp to confirm your order.",
      instapayConfirm: "Go to InstaPay",
      instapayDoneTitle: "Payment Initiated",
      instapayDoneNote: "Please don't forget to send the payment receipt to our WhatsApp so we can verify and activate your plan immediately.",
      sendToWhatsapp: "Send Receipt to WhatsApp",
  ...
  ar: {
    ...
    checkout: {
      ...
      paidButton: "إرسال الإيصال",
      instapayTitle: "الدفع عبر إنستا باي",
      instapayNote: "سيتم تحويلك الآن إلى تطبيق إنستا باي لإتمام عملية الدفع.",
      instapayInstructions: "١. اضغط على 'الذهاب لإنستا باي' بالأسفل.\n٢. أتمم عملية التحويل.\n٣. خد سكرين شوت للتحويل وابعتها لينا على الواتساب لتأكيد اشتراكك.",
      instapayConfirm: "الذهاب لإنستا باي",
      instapayDoneTitle: "تم بدء الطلب",
      instapayDoneNote: "من فضلك متنساش تبعت صورة التحويل (الإيصال) على الواتساب عشان نفعلك الاشتراك فوراً.",
      sendToWhatsapp: "إرسال الإيصال للواتساب",
      backToPlans: "الرجوع للباقات",
      promoCode: "كود الخصم",
      apply: "تطبيق",
