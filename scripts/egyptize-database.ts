...
async function main() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answerAr: "بمجرد ما تشترك، هبعتلك فورم تقييم شامل. كابتن شيكو هيصمم لك بناءً عليه برنامجك على التطبيق بتاعنا، وهنتابع مع بعض أسبوع بأسبوع عشان نعدل أي حاجة ونضمن إنك ماشي صح.",
      order: 2
    },
    {
  ...
  const policies = [
    {
      slug: "terms",
      titleAr: "شروطنا",
      contentAr: "لما تشترك في أي برنامج مع كابتن شيكو، ده معناه إن صحتك كويسة وإنك استشرت دكتور قبل ما تبدأ أي مجهود بدني. النتايج بتختلف من بطل للتاني وبتعتمد بشكل أساسي على أد إيه إنت ملتزم بالبرنامج اللي حطيناه.",
    },
    {
      slug: "privacy",
